...
public class WeeklyScheduleWriteConfiguration : IEntityTypeConfiguration<WeeklySchedule>
{
    public void Configure(EntityTypeBuilder<WeeklySchedule> builder)
    {
        ...
        builder.Property(w => w.ExecutionDays)
            .HasConversion(
                ...
                json => JsonSerializer
                    .Deserialize<List<EventTime>>(json, JsonSerializerOptions.Default)!)
            .HasColumnName("executed_days");
        ...
        builder.HasMany(w => w.PlannedEvents)
            .WithOne()
            .HasForeignKey("weekly_scheduler_id");
